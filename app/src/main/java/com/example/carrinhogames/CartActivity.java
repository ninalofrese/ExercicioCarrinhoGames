package com.example.carrinhogames;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagemProduto1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                total += precoProduto1;
                Toast.makeText(CartActivity.this, String.format("Valor selecionado R$ %.2f", precoProduto1), Toast.LENGTH_SHORT).show();
        ...
        imagemProduto2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                total += precoProduto2;
                Toast.makeText(CartActivity.this, String.format("Valor selecionado R$ %.2f", precoProduto2), Toast.LENGTH_SHORT).show();
                totalValue.setText(String.format(Locale.GERMANY, "Valor total: R$ %.2f", total));
            }
        });
        ...
        imagemProduto3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                total += precoProduto3;
                Toast.makeText(CartActivity.this, String.format("Valor selecionado R$ %.2f", precoProduto3), Toast.LENGTH_SHORT).show();
                totalValue.setText(String.format(Locale.GERMANY, "Valor total: R$ %.2f", total));
            }
        });
